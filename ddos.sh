...
yellow='\033[33;1m'
clear
toilet -f standard "•⊱•Himel Gazi" -F gay
echo
echo $green"●══════════════════════════════════════●"
echo $red"DOS AND DDOS ATTACK LAUCH VIA TOOL [Himel Gazi]"
echo $green"●══════════════════════════════════════●"
echo $cyan"╱╱╱╱╱╱╱╱╱╱╱Its Not A Name Its Brand╱╱╱╱╱╱╱╱╱╱╱╱"
            echo $green"   ╭━━━╮╱╭━━━╮"
            echo $yellow"   ╰╮╭╮┃╱╰╮╭╮┃ [Himel Updated]" 
            echo $green"   ╱┃┃┃┃╱╱┃┃┃┣━┳━━┳━━┳━━┳━╮"
            echo $red"   ╱┃┃┃┣━━┫┃┃┃╭┫╭╮┃╭╮┃╭╮┃╭╮╮" 
            echo $green"   ╭╯╰╯┣━┳╯╰╯┃┃┃╭╮┃╰╯┃╰╯┃┃┃┃" 
            echo $red"   ╰━━━╯╱╰━━━┻╯╰╯╰┻━╮┣━━┻╯╰╯" 
            echo $green"   ╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╭━╯┃"
            echo $purple"   ╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╰━━╯"
            echo $yellow"╱╱╱╱╱╱╱╱╱╱╱Its Not A Name Its Brand╱╱╱╱╱╱╱╱╱╱╱╱" 
echo $green"●══════════════════════════════════════●"
echo $white"                  MENU                     "
echo $green"●══════════════════════════════════════●"
echo $red"[1].DDOS ATTACK.   "
echo $red"[2].DoS ATTACK.    "
echo $red"[3].BOTNET ATTACK. "
echo $red"[4].EXIT TOOL.     "
echo $green"●══════════════════════════════════════●"
echo $white "╭─"$yellow"Himel Gazi"
read -p " ╰─> " pil
